    ...
    <>
      ...
      >
        ...
        <div
          ...
          } absolute z-50 left-0 top-full flex-row items-center justify-between w-screen px-3 py-2 h-[50vh] shadow-md shadow-slate-600 transition duration-200 bg-black ease-in`}
        >
